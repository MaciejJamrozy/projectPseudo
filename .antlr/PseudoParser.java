...
public class PseudoParser extends Parser {
	...
	public static final int
		...
		T__9=10, T__10=11, T__11=12, T__12=13, STRING=14, NUMBER=15, DOUBLE=16, 
		ID=17, WS=18, ESC=19, PLUS=20, MINUS=21, MULT=22, DIV=23, EQ=24;
	public static final int
		RULE_program = 0, RULE_statement = 1, RULE_printStatement = 2, RULE_assignStatement = 3, 
		RULE_expr = 4;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "statement", "printStatement", "assignStatement", "expr"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, "STRING", "NUMBER", "DOUBLE", "ID", "WS", "ESC", "PLUS", 
			"MINUS", "MULT", "DIV", "EQ"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 131102L) != 0)) {
				{
				{
				setState(10);
				statement();
	...
	public final AssignStatementContext assignStatement() throws RecognitionException {
		...
		try {
			...
			setState(28);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 16778112L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
