...
public class PseudoParser extends Parser {
	...
	public static final int
		...
		WS=32, PLUS=33, MINUS=34, MULT=35, DIV=36, EQ=37, GREATER=38, SMALLER=39, 
		EQUAL=40, DIFFERENT=41, TYPE=42, TYPE_INT=43, TYPE_FLOAT=44, TYPE_STRING=45, 
		TYPE_BOOL=46, ID=47;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'||'", "'not'", "'and'", "'or'", null, null, null, null, null, "'+'", 
			"'-'", "'*'", "'/'", "'='", "'>'", "'<'", "'=='", "'!='", null, "'int'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, "STRING", "NUMBER", "DOUBLE", "BOOL", "WS", "PLUS", 
			"MINUS", "MULT", "DIV", "EQ", "GREATER", "SMALLER", "EQUAL", "DIFFERENT", 
			"TYPE", "TYPE_INT", "TYPE_FLOAT", "TYPE_STRING", "TYPE_BOOL", "ID"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 145135535079948L) != 0)) {
				{
				{
				setState(28);
				statement();
	...
	public final VarDeclStatementContext varDeclStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 137438953920L) != 0)) {
				{
				setState(55);
	...
	public final FunctionCallStatementContext functionCallStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 140741556305936L) != 0)) {
				{
				setState(173);
				argumentList();
				}
