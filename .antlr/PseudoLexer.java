...
public class PseudoLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "T__18", "T__19", "T__20", "T__21", "STRING", "ESC", "NUMBER", 
			"DOUBLE", "BOOL", "WS", "PLUS", "MINUS", "MULT", "DIV", "GREATER", "SMALLER", 
			"EQUAL", "DIFFERENT", "AND", "OR", "NOT", "TYPE", "TYPE_INT", "TYPE_FLOAT", 
